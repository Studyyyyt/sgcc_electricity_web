...
from .api.electricity_user_info_userId import ElectricityUserInfoUserid
...
routes = [
    ...
    dict(resource=ElectricityUserInfoUserid, urls=['/electricity/user_info/<userId>'], endpoint='electricity_user_info_userId'),
